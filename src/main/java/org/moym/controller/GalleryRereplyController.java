...
import org.moym.service.GalleryRereplyService;
...
@RequestMapping("/galleryRereplies/")
@RestController
@Log4j
@AllArgsConstructor
public class GalleryRereplyController {
	
	
	private GalleryRereplyService rereplyService;
