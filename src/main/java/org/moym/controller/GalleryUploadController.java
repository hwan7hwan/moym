...
public class GalleryUploadController {
	...
	@PostMapping(value = "/galleryUploadAjaxAction", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseBody
	...
	@GetMapping("/galleryDisplay")
		...
		public ResponseEntity<byte[]> getFile(String fileName, HttpServletRequest request){
			...
			File file = new File(root_path+"/upload/gallery/" + fileName);
		...
		@GetMapping(value = "/galleryDownload", produces = MediaType.APPLICATION_OCTET_STREAM_VALUE)
		@ResponseBody
		public ResponseEntity<Resource> downloadFile(@RequestHeader("User-Agent") String userAgent, String fileName, HttpServletRequest request){
			...
			Resource resource = new FileSystemResource(root_path+"/upload/gallery/" + fileName);
		...
		public ResponseEntity<String> deleteFile(String fileName, String type, HttpServletRequest request){
			...
			try {
				file = new File(root_path+ "/upload/gallery/" + URLDecoder.decode(fileName,"UTF-8"));
				file.delete();
