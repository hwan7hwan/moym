...
import org.moym.service.NoticeRereplyService;
...
@RequestMapping("/noticeRereplies/")
@RestController
@Log4j
@AllArgsConstructor
public class NoticeRereplyController {
	
	
	private NoticeRereplyService rereplyService;
