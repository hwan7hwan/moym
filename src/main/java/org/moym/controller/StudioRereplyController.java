...
import org.moym.service.StudioRereplyService;
...
@RequestMapping("/studioRereplies/")
@RestController
@Log4j
@AllArgsConstructor
public class StudioRereplyController {
	
	
	private StudioRereplyService rereplyService;
