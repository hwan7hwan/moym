...
import org.moym.mapper.StudioBoardAttachMapper;
...
import org.moym.mapper.StudioThumbimgMapper;
...
@Service
@AllArgsConstructor
public class StudioBoardServiceImpl implements StudioBoardService{
	
	@Setter(onMethod_ = @Autowired)
	private StudioBoardMapper mapper;			//memoByHwan  define mapper object
	
	@Setter(onMethod_ = @Autowired)
	private StudioBoardAttachMapper attachMapper;
	
	@Setter(onMethod_ = @Autowired)		//memoByHwan before u remove board, u need to delete reply fisrt!!!
	private StudioReplyMapper replyMapper;
	
	@Setter(onMethod_ = @Autowired)		//memoByHwan before u remove board, u need to delete reply fisrt!!!
	private StudioRereplyMapper rereplyMapper;
	
	@Setter(onMethod_ = @Autowired)		//memoByHwan before u remove board, u need to delete reply fisrt!!!
	private StudioThumbimgMapper thumbMapper;
