            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
                    <div class="form-head">
                        ...
                        <form id="forgotID_form" method="post">
                        ...
                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" /> 
                            ...
                            <div class="mail_wrap row">
                            	<div class="form-group mail_input_box">
                                	<label>가입 시 입력한 이메일 주소를 입력해주세요</label>
                            ...
                            <p class="outer-link marBotH">You Remember the Password? <a href="/customLogin">Login</a></p>
                            
                            
                            <div class="form-group">
                                <label>아이디를 입력해주세요</label>
                                <span class="final_id_ck">아이디를 입력해주세요.</span>
                                <span class="id_input_re_1">아이디가 확인되었습니다.</span>
								<span class="id_input_re_2">해당 이메일 주소와 일치하지 않는 아이디 입니다.</span>
...
$(document).ready(function(){
	...
	$(".chgPW_button").click(function(){
		...
		// End Of availability for Change Password Form
		if(idCheck&&idckCheck&&pwCheck&&pwckCheck&&pwckcorCheck&&mailCheck&&mailnumCheck){
			$("#forgotID_form").attr("action", "/member/forgotAccount");
...
$(".mail_check_button").click(function(){
    ...
    if(mailFormCheck(email)){
 	...
 	$.ajax({
        type:"GET",
        url:"mailCheckFgAcc?email=" + email,
