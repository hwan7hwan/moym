        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1 col-md-12 col-12">
                    ...
                    <form id='operForm' action="/cafe/modify" method="get"><!-- You should check the route!! -->
...
$(document).ready(function(){
	...
	$("button[data-oper='modify']").on("click", function(e){
		operForm.attr("action", "/menu/cafe/modify").submit();
	...
	$("button[data-oper='list']").on("click", function(e){
		...
		operForm.attr("action","/menu/cafe/list")
		operForm.submit();		
	});	
});
...
$(document).ready(function(){
	(function(){
		...
		$.getJSON("/menu/cafe/getAttachList", {bno: bno}, function(arr){
