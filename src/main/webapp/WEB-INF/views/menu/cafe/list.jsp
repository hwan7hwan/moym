...
<!-- memoByHwan Start Form tag for Category Search -->
            	<form id='searchForm' action="/menu/cafe/list" method="get">
                        <div class="row">
...
<!-- memoByHwan End Form -->
        ...
        <div class="row">
            ...
            <table class="table table-striped tableMarginTopC">
                <thead class="table-primary">
                  <tr>
                    <th scope="col" class="col-12">Chat</th>
                    <!-- 
        ...
        <form id = 'actionForm' action="/menu/cafe/list" method="get">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#regBtn").on("click", function(){
			self.location = "/menu/cafe/register";
		});
