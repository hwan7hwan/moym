            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="form-main">
                        ...
                        <form class="form" role="form" action="/menu/cafe/modify" method="post" id='modForm'>
...
$(document).ready(function(){
	...
	$('button').on("click", function(e){
		...
		if(operation === 'remove'){
			formObj.attr("action", "/menu/cafe/remove");
		}else if(operation === 'list'){
			//move to list
			formObj.attr("action", "/menu/cafe/list").attr("method","get");
