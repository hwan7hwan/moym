        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1 col-md-12 col-12">
                                        ...
                                        <div class="tags">
                                            <div class="button">
                                                ...
                                                <sec:authentication property="principal" var="pinfo"/>
                                                	<sec:authorize access="isAuthenticated()">			<!-- khh username means userID!!!!  -->
                    ...
                    <form id='operForm' action="/cafe/notice/modify" method="get"><!-- You should check the route!! -->
...
<script type="text/javascript" src="/resources/js/noticeRereply.js"></script>
...
$(document).ready(function(){
	...
	$("button[data-oper='modify']").on("click", function(e){
		operForm.attr("action", "/menu/cafe/notice/modify").submit();
	...
	$("button[data-oper='list']").on("click", function(e){
		...
		operForm.attr("action","/menu/cafe/notice/list")
		operForm.submit();		
	});	
});
