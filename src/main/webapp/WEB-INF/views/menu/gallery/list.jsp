...
<!-- memoByHwan Start Form tag for Category Search -->
            	<form id='searchForm' action="/menu/gallery/list" method="get">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    <select name="type" class="select">
                                    	<option value=""
             							...
             							<option value="M"
             								<c:out value="${pageMaker.cri.type eq 'M'?'selected':''}"/>>Music</option>
             							<option value="B"
             								<c:out value="${pageMaker.cri.type eq 'B'?'selected':''}"/>>Book</option>
             							<option value="R"
             								<c:out value="${pageMaker.cri.type eq 'R'?'selected':''}"/>>Art</option>
...
<!-- Pagination -->
        ...
        <form id = 'actionForm' action="/menu/gallery/list" method="get">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#regBtn").on("click", function(){
			self.location = "/menu/gallery/register";
		});
	...
	$(".move").on("click", function(e){
		...
		actionForm.attr("action","/menu/gallery/get");
		actionForm.submit();
