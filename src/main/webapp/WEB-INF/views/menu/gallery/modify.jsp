            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="form-main">
                        ...
                        <form class="form" role="form" action="/menu/gallery/modify" method="post" id='modForm'>
...
$(document).ready(function(){
	...
	$('button').on("click", function(e){
		...
		if(operation === 'remove'){
			formObj.attr("action", "/menu/gallery/remove");
		}else if(operation === 'list'){
			//move to list
			formObj.attr("action", "/menu/gallery/list").attr("method","get");
...
$(document).ready(function(){
	...
	$.getJSON("/menu/gallery/getThumbList", {bno: bno}, function(arr){
