        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1 col-md-12 col-12">
                    ...
                    <form id='operForm' action="/storage/modify" method="get"><!-- You should check the route!! -->
...
<script src="/resources/js/storageReply.js"></script>
<script src="/resources/js/storageRereply.js"></script>
...
$(document).ready(function(){
	...
	$("button[data-oper='modify']").on("click", function(e){
		operForm.attr("action", "/menu/storage/modify").submit();
	...
	$("button[data-oper='list']").on("click", function(e){
		...
		operForm.attr("action","/menu/storage/list")
		operForm.submit();		
	});	
});
