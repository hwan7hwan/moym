            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="form-main">
                        ...
                        <form class="form" role="form" action="/menu/storage/modify" method="post" id='modForm'>
...
$(document).ready(function(){
	...
	$('button').on("click", function(e){
		...
		if(operation === 'remove'){
			formObj.attr("action", "/menu/storage/remove");
		}else if(operation === 'list'){
			//move to list
			formObj.attr("action", "/menu/storage/list").attr("method","get");
...
$(document).ready(function(){
	(function(){
		...
		$.getJSON("/menu/storage/getAttachList", {bno: bno}, function(arr){
	...
	$.getJSON("/menu/storage/getThumbList", {bno: bno}, function(arr){
