        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1 col-md-12 col-12">
                    ...
                    <form id='operForm' action="/studio/modify" method="get"><!-- You should check the route!! -->
...
<script src="/resources/js/studioReply.js"></script>
<script src="/resources/js/studioRereply.js"></script>
...
$(document).ready(function(){
	...
	$("button[data-oper='modify']").on("click", function(e){
		operForm.attr("action", "/menu/studio/modify").submit();
	...
	$("button[data-oper='list']").on("click", function(e){
		...
		operForm.attr("action","/menu/studio/list")
		operForm.submit();		
	});	
});
