...
<!-- memoByHwan Start Form tag for Category Search -->
            	<form id='searchForm' action="/menu/studio/list" method="get">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    <select name="type" class="select">
                                    	<option value=""
             							...
             							<option value="S"
             								<c:out value="${pageMaker.cri.type eq 'M'?'selected':''}"/>>Song Writing</option>
             							<option value="G"
             								<c:out value="${pageMaker.cri.type eq 'B'?'selected':''}"/>>Acoustic Guitar</option>
             							<option value="M"
             								<c:out value="${pageMaker.cri.type eq 'R'?'selected':''}"/>>About Music</option>
...
<!-- Pagination -->
        ...
        <form id = 'actionForm' action="/menu/studio/list" method="get">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#regBtn").on("click", function(){
			self.location = "/menu/studio/register";
		});
	...
	$(".move").on("click", function(e){
		...
		actionForm.attr("action","/menu/studio/get");
		actionForm.submit();
