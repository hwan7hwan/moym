...
<!-- Start Breadcrumbs -->
<div class="breadcrumbs overlay studioPageHwan">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                <div class="breadcrumbs-content">
                    <h1 class="page-title">Studio</h1>
                    <p>여러분도 아티스트가 될 수 있습니다. <br> 창작에 도움이 되는 정보가 있는 공간입니다.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="form-main">
                        ...
                        <form class="form" role="form" action="/menu/studio/modify" method="post" id='modForm'>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="select" name="category">                                
                                            ...
                                            <option value="aboutMusic">About Music</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input name="ytlink" type="text" value='<c:out value="${board.ytlink}"/>' placeholder='type if you need to'>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        <label>Summary</label>
                                        <input name="quocon" type="text" value='<c:out value="${board.quocon}"/>' placeholder='type if you need to'>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        <label>Summary From</label>
                                        <input name="quofrom" type="text" value='<c:out value="${board.quofrom}"/>' placeholder='type if you need to'>
                                    </div>
                                </div>
...
$(document).ready(function(){
	...
	$('button').on("click", function(e){
		...
		if(operation === 'remove'){
			formObj.attr("action", "/menu/studio/remove");
		}else if(operation === 'list'){
			//move to list
			formObj.attr("action", "/menu/studio/list").attr("method","get");
...
$(document).ready(function(){
	(function(){
		...
		$.getJSON("/menu/studio/getAttachList", {bno: bno}, function(arr){
		...
		});//end getJSON		//to show upload files
		
		
		
	$.getJSON("/menu/studio/getThumbList", {bno: bno}, function(arr){
			...
			$(arr).each(function(i, attach){
				...
				if(attach.fileType){
					...
					str += "<button type='button' data-file=\'"+fileCallPath+"\' data-type='image'";
					str += "class='btn btn-circle'><i class='lni lni-close'></i></button><br>";
					str += "<img src='/thgalleryDisplay?fileName="+fileCallPath+"'>";
					str += "</div>";
					str +="</li>";
		...
		$.ajax({
			url: '/thgalleryUploadAjaxAction',
				...
				data: formData,
					...
					success: function(result){
					console.log(result);
					showUploadResultTh(result);// Function for result of upload
				}
			});	//ajax
